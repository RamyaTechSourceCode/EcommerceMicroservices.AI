...
{
    private readonly IBedrockAgentService _agent;

    public ChatAssistantController(IBedrockAgentService agent)
    {
        _agent = agent;
    }
...
//DEcides between RAG search or Agentic tool execution based on user intent triggers
/*private readonly IMediator _mediator;
private readonly Kernel _kernel;
// private readonly IChatCompletionService _chatService;
private readonly IBedrockChatService _bedrockChatService;
public ChatAssistantController(IMediator mediator, Kernel kernel, 
    ECommerceMcpToolsPlugin mcpPlugin, IBedrockChatService bedrock)
{
    _mediator = mediator;
    _kernel = kernel;
